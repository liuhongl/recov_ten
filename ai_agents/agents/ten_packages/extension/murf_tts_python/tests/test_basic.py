...
def test_dump_functionality(MockMurfTTSClient):
    ...
    tester.set_test_mode_single("murf_tts_python", json.dumps(dump_config))
...
@patch("murf_tts_python.extension.MurfTTSClient")
def test_text_input_end_logic(MockMurfTTSClient):
    """
...
@patch("murf_tts_python.extension.MurfTTSClient")
def test_flush_logic(MockMurfTTSClient):
    """
    ...
    def mock_cancel(_request_id: str):
        cancel_event.set()
