...
static esp_err_t recorder_pipeline_open(void)
{
  ...
  algo_config.algo_mask  = 0;  // Hardware AEC on XVF3800, no software algorithms needed
  algo_config.swap_ch    = true;
  algo_config.task_stack = 6 * 1024;  // Reduced from default 5KB, no AEC processing needed
