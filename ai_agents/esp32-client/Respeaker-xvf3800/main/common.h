...
#define TENAI_AUDIO_CODEC           "{\"che.audio.custom_payload_type\":9,\"che.audio.codec_unfallback\":[0,8,9]}"
...
#define CONFIG_SEND_PCM_DATA
#define TENAI_AUDIO_CODEC           "{\"che.audio.custom_payload_type\":0,\"che.audio.codec_unfallback\":[0,8,9]}"
#else
