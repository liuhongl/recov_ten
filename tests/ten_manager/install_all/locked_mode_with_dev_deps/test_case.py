...
def test_tman_install_locked_with_dev_deps():
    """Test tman install --locked installs both dependencies and dev_dependencies."""
    ...
    if returncode != 0:
        print(output_text)
        assert False, "tman install --locked should succeed with dev_dependencies"

    analyze_resolve_result(app_dir)


if __name__ == "__main__":
    test_tman_install_locked_with_dev_deps()
