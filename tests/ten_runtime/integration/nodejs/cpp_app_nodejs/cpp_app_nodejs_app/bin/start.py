#!/usr/bin/env python3
"""
Cross-platform start script for C++ apps with Node.js extensions on Windows.
...
# Run the C++ app executable
main_exe = os.path.join(app_root, "bin", "cpp_app_nodejs_app.exe")
